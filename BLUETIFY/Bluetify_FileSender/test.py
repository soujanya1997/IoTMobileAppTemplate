...
class New_Toplevel_1:
    def __init__(self, top=None):
        ...
        top.geometry("445x454+682+209")
        top.title("New Toplevel 1")
        top.configure(background="#00e4de")



        self.Label1 = Label(top)
        self.Label1.place(relx=0.0, rely=0.0, height=348, width=446)
        self.Label1.configure(background="#000000")
        self._img1 = PhotoImage(file="../Bluetooth_FrontEnd/giphy.gif")
        self.Label1.configure(image=self._img1)
        self.Label1.configure(text='''Label''')
        self.Label1.configure(width=446)

        self.Button2 = Button(top)
        self.Button2.place(relx=0.31, rely=0.81, height=56, width=157)
        self.Button2.configure(activebackground="#d9d9d9")
        self.Button2.configure(text='''NEXT''')
        self.Button2.configure(width=157)

        self.Scrolledlistbox3 = ScrolledListBox(top)
        self.Scrolledlistbox3.place(relx=0.13, rely=0.4, relheight=0.31
                , relwidth=0.76)
        ...
        self.Button3.place(relx=0.31, rely=0.13, height=66, width=167)
        self.Button3.configure(activebackground="#d9d9d9")
        self.Button3.configure(text='''SCAN''')
